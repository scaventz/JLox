...
public class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    // First, we resolve the expression for the assigned value in case it also contains references to other variables.
    // Then we use our existing resolveLocal() method to resolve the variable that’s being assigned to.
    @Override
    ...
    private void declare(Token name) {
        ...
        // The value associated with a key in the scope map represents whether or not we
        // have finished resolving that variable’s initializer.
